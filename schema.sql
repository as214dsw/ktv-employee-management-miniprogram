CREATE DATABASE IF NOT EXISTS ktv_management DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE teams (
    ...
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (creator_openid) REFERENCES users(openid) ON DELETE CASCADE
);
